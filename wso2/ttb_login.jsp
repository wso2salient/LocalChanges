...
%>
    ...
    <div class="container-fluid body-wrapper">
        ...
        <div class="row">
                ...
                <!-- content -->
                <div class="container col-xs-10 col-sm-6 col-md-4 col-lg-4 wr-login"> 
                    <div style="text-align: center;">
                            <img src="./images/ttb_logo1.png" alt="ttb_logo" style="background-color: #f9f9f9">
                            <h2 class="col-centered">Log In</h2>
                     </div>   
                
                    
                    <!-- <div>
                         <h2 class="wr-title uppercase padding-double white margin-none">
                            <%
                                if (isIdentifierFirstLogin(inputType)) {
                            %>
...
<%
                    ...
                    <!-- /content -->
                    <div class="col-md-8 col-lg-8" style="border: 1px solid black">
                         <h1>Notice</h1>   
                    </div>
                </div>
